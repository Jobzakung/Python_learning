...
video = cv.VideoCapture("week7/blue-screen-effect-OpenCV-master/137986 (1080p).mp4")
image = cv.imread("week7/blue-screen-effect-OpenCV-master/severin-hoin-jkM4W3VnfHg-unsplash.jpg")
